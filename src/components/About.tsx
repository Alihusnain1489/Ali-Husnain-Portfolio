    ...
    <section id="about" className="relative bg-background py-24 lg:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-12">
        ...
        <div className="grid gap-16 lg:grid-cols-[1.2fr_1fr] items-start">
          ...
          <div className="space-y-6 text-base leading-relaxed text-foreground/75">
            <p>
        ...
        {/* Stats strip */}
        <div className="mt-20 grid grid-cols-2 gap-px overflow-hidden border border-border bg-border lg:grid-cols-4">
          {[
            ...
            <div key={s.v} className="bg-background p-8">
              <p className="font-playfair text-4xl text-foreground">{s.k}</p>
