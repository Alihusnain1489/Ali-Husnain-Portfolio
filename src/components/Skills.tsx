...
import { Code, Database, Palette, Globe, Zap, Layers, Star } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-12">
          {Object.entries(categories).map(([categoryName, categorySkills]) => (
            <Card key={categoryName} className="hover:shadow-xl hover:shadow-cyan-500/10 transition-all duration-300 border-cyan-500/30 bg-black/60 backdrop-blur-sm">
              <CardContent className="p-8">
                <h3 className="text-2xl font-semibold text-white mb-8 text-center flex items-center justify-center gap-2">
                  {categoryName === "Frontend" ? <Code className="h-6 w-6 text-cyan-400" /> : <Database className="h-6 w-6 text-blue-400" />}
                          ...
                          <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <div className="flex items-center gap-1 mb-2">
                                ...
                                <span className="text-xs text-gray-400 ml-2">{skill.experience}</span>
                              </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-300 text-sm">
                  Building responsive and interactive user interfaces with modern React and TypeScript
                </p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-300 text-sm">
                  Creating robust server-side applications with Java and Spring Boot
                </p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-300 text-sm">
                  End-to-end web development from database design to user interface
                </p>
              </div>
            </div>
          </CardContent>
